...
grep -r "^DATA" simulated-run-$1/output* | sort | cut --complement -f1 > simulated-run-$1/full-simulated-run.tsv
echo INFO: Assembling the unique resulting data and writing it to simulated-run-$1/uniq-simulated-run.tsv
grep -r "^DATA" simulated-run-$1/output* | sort | uniq | cut --complement -f1 > simulated-run-$1/uniq-simulated-run.tsv
echo INFO: All done!
