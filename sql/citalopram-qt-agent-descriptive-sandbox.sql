...
SELECT de1.person_id, de1.drug_exposure_id AS citalopram_dexp, de1.drug_concept_id AS citalopram_id, c1.concept_name AS citalopram_name, cs1.concept_name AS citalopram_ingr, de1.drug_exposure_start_datetime AS citalopram_start, de1.drug_exposure_end_datetime AS citalopram_end, de1.quantity, de1.sig, de1.route_concept_id as citalopram_route_id, de1.route_source_value as citalopram_route,
de2.drug_exposure_id AS qt_dexp, de2.drug_concept_id AS qt_id, c2.concept_name AS qt_name, cs2.concept_name AS qt_ingr, de2.drug_exposure_start_datetime AS beta_start, de2.drug_exposure_end_datetime AS beta_end, de2.quantity, de2.sig, de2.route_concept_id AS qt_route_id, de2.route_source_value AS qt_route,
...
-- basic concomitant -- expect 25 rows from query. Rule got 19.
